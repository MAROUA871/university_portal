            ...
            <?php foreach ($rows as $row) : ?>
                        ...
                        <form method="POST">
                            ...
                            <td>
                                <input type="number" step="0.01" min="0" max="20" name="td_value"
                                       class="note-input"
                                       value="<?php echo ($row["td_note"] !== null) ? htmlspecialchars($row["td_note"]) : ""; ?>">
                            </td>

                            <td>
                                <input type="number" step="0.01" min="0" max="20" name="exam_value"
                                       class="note-input"
                                       value="<?php echo ($row["exam_note"] !== null) ? htmlspecialchars($row["exam_note"]) : ""; ?>">
                            </td>
                ...
                <?php else : ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($row["identifier"]); ?></td>
                        <td><?php echo htmlspecialchars($row["code"] . " - " . $row["name"]); ?></td>
                        <td><?php echo ($row["td_note"] !== null) ? number_format($row["td_note"], 2) : ""; ?></td>
                        <td><?php echo ($row["exam_note"] !== null) ? number_format($row["exam_note"], 2) : ""; ?></td>
                        <td>
                            <a class="action-btn" href="notes.php?student_id=<?php echo $row["student_id"]; ?>&module_id=<?php echo $row["module_id"]; ?>">
                                Edit
                            </a>
                        </td>
                    </tr>
